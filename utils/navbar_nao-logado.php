 ...
 <div class="navlogo">
  <a href="index.php"> <img src="assets\imagens\logo-solum.png"> </a>
        ...
        <div class="navbar-pesquisa">
            <form class="form-pesquisa" onsubmit="buscarProdutos(event)">
                <input type="text" placeholder="Buscar produtos sustentáveis..." id="inputPesquisa">
...
<div class="navlinkcategoria">
<a href="loja.php" style="text-decoration: none; color: #131a2b; "> <strong>Lojas</strong> </a>
</div>
