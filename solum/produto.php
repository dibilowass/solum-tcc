...
session_set_cookie_params([
    ...
    'secure' => true,              // Garante que só é enviado via HTTPS
    'httponly' => true,            // Impede acesso via JavaScript
    'samesite' => 'Lax'            // Permite navegação básica sem quebrar sessão
]);
...
<p class="produto-display-preco">R$ <?= $proPreco ?> 
  ...
  <br>
      ...
      <form action="add-carrinho.php" method="post" class="">
          <button type="submit" class="btn btn-primary" value="AddCarrinho" id="addCarrinho">Adicionar ao carrinho <i class="bi bi-bag-plus-fill"></i></button>
