...
<div class="containerLojas">
  ...
  <form method="GET" action="lojas.php" class="filters-form" style="margin-bottom:16px; display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
    <input type="text" name="q" placeholder="Buscar por nome" value="<?= isset($_GET['q']) ? htmlspecialchars($_GET['q']) : '' ?>" style="padding:8px; border:1px solid #ddd; border-radius:6px;">
    <input type="number" name="minProducts" placeholder="Mínimo de produtos" value="<?= isset($_GET['minProducts']) ? (int)$_GET['minProducts'] : '' ?>" style="width:160px; padding:8px; border:1px solid #ddd; border-radius:6px;">
